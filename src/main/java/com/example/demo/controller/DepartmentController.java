...
public class DepartmentController {
	...
	public ResponseEntity<ApiResponse> uploadDepartments(@RequestParam("file") MultipartFile file) {

		Long orgid = utilService.authorize();

		return ResponseEntity.status(HttpStatus.CREATED).body(new ApiResponse(HttpStatus.CREATED.value(),
				"File Uploaded successfully", deptService.uploadDepartments(file.getName(), orgid)));
	}
